...
CREATE TABLE company_admin(
    email VARCHAR2(50 CHAR) CONSTRAINT pk_company_admin_email PRIMARY KEY,
    password VARCHAR2(20 CHAR),
    name VARCHAR2(30 CHAR),
    belong VARCHAR2(20 CHAR),
...
CREATE TABLE company(
    c_id VARCHAR2(10 CHAR) CONSTRAINT pk_company_cid PRIMARY KEY,
    c_password VARCHAR2(20 CHAR),
    c_eamil VARCHAR2(30 CHAR),
    c_address VARCHAR2(30 CHAR),
    c_phone VARCHAR2(20 CHAR),
    c_business_number VARCHAR2(20 CHAR),
    c_created_at DATE
);
